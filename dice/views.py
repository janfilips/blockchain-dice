...
def ajax_notifications(request):
    ...
    if(recent_event):
        ...
        if(recent_event.event_type == "player_wins"):
            ...
            notification_text = "Congratulations your transaction <a href=\""+recent_event.tx_hash+"\"><font color=\"#C0C0C0\">"+str(tx_hash_shorten)+"</font></a> bet "+str(recent_event.numbers).replace('[','').replace(']','')+" on number <b>"+str(recent_event.win_number)+"</b> wins <b>"+str(recent_event.win_amount)+" Ether</b>."
